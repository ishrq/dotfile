...
map('n', '<Leader>t1', '<CMD>tabnext1<CR>', {})
map('n', '<Leader>t2', '<CMD>tabnext2<CR>', {})
map('n', '<Leader>t3', '<CMD>tabnext3<CR>', {})
map('n', '<Leader>t4', '<CMD>tabnext4<CR>', {})
map('n', '<Leader>t5', '<CMD>tabnext5<CR>', {})
map('n', '<Leader>t6', '<CMD>tabnext6<CR>', {})
map('n', '<Leader>t7', '<CMD>tabnext7<CR>', {})
map('n', '<Leader>t8', '<CMD>tabnext8<CR>', {})
map('n', '<Leader>t9', '<CMD>tabnext9<CR>', {})
